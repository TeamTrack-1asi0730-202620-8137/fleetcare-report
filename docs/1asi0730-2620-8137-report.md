...
> **Link:** [Segment 2 - Interviews](https://upcedupe-my.sharepoint.com/:v:/g/personal/)
...
<p style="text-align: justify;">
  El entorno de desarrollo incluye Visual Studio Code como editor de código, Git para el control de versiones y GitHub como plataforma para la administración de los repositorios remotos. Para la Landing Page se utilizan HTML, CSS y JavaScript, mientras que la Web Application se desarrolla como una Single Page Application utilizando Vue.js.
</p>
...
| **Vue.js** | Framework utilizado para desarrollar la SPA correspondiente a la Web Application |
| **npm** | Administrador de paquetes utilizado para gestionar las dependencias de la aplicación desarrollada con Vue.js |

...
<table style="width: 100%; border-collapse: collapse; margin: auto; table-layout: fixed; width: 100%;">
  ...
  <tr>
    ...
    <td style="text-align: justify;">
      Sistema de diseño UI/UX completo, que incluye esquemas de estructura (*wireframes*), maquetas de alta fidelidad y diagramas de flujo (*wireflows* y flujos de usuario) para las vistas de la aplicación.
    </td>
  </tr>
  <!-- ROW 3 -->
  <tr>

...
<tr>
  ...
  <tr>
    ...
    <td style="text-align: justify;">
      En esta entrega se definieron historias de usuario para representar las principales funcionalidades según las necesidades de los usuarios. También se elaboró un mapa de impacto para relacionar los objetivos del negocio con los usuarios y las funcionalidades del sistema. Finalmente, el Product Backlog fue organizado, priorizado y estimado utilizando la escala de Fibonacci para apoyar el proceso de desarrollo.
    </td>
  </tr>
  <!-- ROW 6 -->
...
**Segment 2: Conductores de carga ligera**
...
┌─────────┬─────────────┬──────────┬────────────┬────────┐
│   🏠    │     🔧      │    🚚    │     📋     │   ⋮    │
│  Home   │ Maintenance │ Vehicles │  History   │  More  │
└─────────┴─────────────┴──────────┴────────────┴────────┘
```
...
<div style="text-align: center;">
  <img src="../assets/chapter-4/software-architecture/context-diagram/c4-diagrama-de-contexto.png" width="85%" alt="wireframe-web-1">
</div>

### **4.6.3. Software Architecture Container Diagrams**

<div style="text-align: center;">
  <img src="../assets/chapter-4/software-architecture/container-diagram/c4-diagrama-de-contenedores.png" width="85%" alt="wireframe-web-1">
</div>

### **4.6.4. Software Architecture Components Diagrams**

<div style="text-align: center;">
  <img src="../assets/chapter-4/software-architecture/components-diagram/c4-diagrama-de-componentes-gestion-de-flota.png" width="85%" alt="wireframe-web-1">
</div>
<br>
<div style="text-align: center;">
  <img src="../assets/chapter-4/software-architecture/components-diagram/c4-diagrama-de-componentes-gestion-de-inspecciones.png" width="85%" alt="wireframe-web-1">
</div>
...
<ul>
  ...
  <li>
    <b>Web Application Repository:</b><br>
    Contiene el código fuente de la Single Page Application desarrollada con Vue.js.<br>
    <code>FLEETCARE_WEBAPP_REPOSITORY_URL</code>
  </li>
</ul>
...
<p style="text-align: justify;">
  La Web Application de FleetCare se encuentra actualmente en desarrollo como una Single Page Application utilizando Vue.js. En esta entrega, el trabajo se concentra en la implementación de la interfaz, navegación, vistas y componentes correspondientes a los principales módulos funcionales.
</p>

<p style="text-align: justify;">
  La estructura de la SPA considera Fleet Management, Inspection Management, Incident Management, Maintenance Management y Vehicle Operations Management como sus principales módulos funcionales. Dashboard se mantiene como una vista transversal y User Access and Roles como una capacidad compartida.
</p>

**Repository:**

```text
FLEETCARE_WEBAPP_REPOSITORY_URL
```

<p style="text-align: justify;">
  Debido a que la Web Application continúa en desarrollo, la URL definitiva de despliegue deberá incorporarse cuando la versión correspondiente a esta aplicación sea publicada.
</p>

**Future Deployment URL:**

```text
FLEETCARE_WEBAPP_DEPLOYMENT_URL
```
